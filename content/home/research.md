...
</div> <div class="alert" style="width: 700px; float:left; height:250px"> <p>An overarching focus of my research is geared towards prudently resuing data to exploit complex patterns in big data reproducible modeling and report tractably resolvable inferential conclusions with meaning. My recent activities draw direct motivation from how big and rich data is collected, stored and deployed in realistic pipelines. 
   <br>
