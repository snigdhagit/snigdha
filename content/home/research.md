...
My recent and ongoing work overcomes these limitations, paving the way for flexible, tractable, and scalable methods of selective inference. Here are some main themes of research.
  ...
  <p><b><span style="color: #00008B"> Beyond polyhedral-shaped selection events</b>: click here <a href="javascript:void(0)" onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'">here</a>
  </p>
  ...
  <p><b><span style="color: #00008B"> Distribution-free inferences</b>: click here <a href="javascript:void(0)" onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'">here</a>
  </p>
  ...
  <p><b><span style="color: #00008B"> Tractable and scalable inferences</b>: click here <a href="javascript:void(0)" onclick="document.getElementById('light').style.display='block';document.getElementById('fade').style.display='block'">here</a>
  </p>
